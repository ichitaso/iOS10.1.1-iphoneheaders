...
typedef struct {
	unsigned dateAlertActivelyDismisssed : 1;
	unsigned dateAlertEngaged : 1;
	unsigned dateAlertWasCovered : 1;
	unsigned dateAlertWasScrolled : 1;
	unsigned dateAllClearedFromNotificationCenter : 1;
	unsigned dateCrownPressed : 1;
	unsigned dateDelivered : 1;
	unsigned dateSpecificallyClearedFromNotificationCenter : 1;
	unsigned dateWristQuicklyRaised : 1;
	unsigned timestamp : 1;
	unsigned batteryLevelDuringDelivery : 1;
	unsigned coreRoutineLocationOfInterestTypeDuringDelivery : 1;
	unsigned numberOfNotificationsInNotificationCenter : 1;
	unsigned didHapticPlayDuringDelivery : 1;
	unsigned didSoundPlayDuringDelivery : 1;
	unsigned noInteractionWithinMaxWindow : 1;
	unsigned wasDoNotDisturbEnabledDuringDelivery : 1;
	unsigned wasInCalendarEventDuringDelivery : 1;
	unsigned wasNotificationPrivacyEnabledDuringDelivery : 1;
	unsigned wasScreenOnDuringDelivery : 1;
	unsigned wasSilentModeEnabledDuringDelivery : 1;
	unsigned wasUnreadNotificationsIndicatorEnabledDuringDelivery : 1;
} SCD_Struct_AW8;
