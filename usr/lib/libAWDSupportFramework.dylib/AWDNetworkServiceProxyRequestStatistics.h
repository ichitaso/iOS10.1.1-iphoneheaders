...
@interface AWDNetworkServiceProxyRequestStatistics : PBCodable <NSCopying> {
	...
	SCD_Struct_AW27* _directConnectionFirstByteBuckets;
	SCD_Struct_AW27* _directConnectionLastByteBuckets;
	SCD_Struct_AW27* _firstByteBuckets;
	SCD_Struct_AW27* _lastByteBuckets;
	SCD_Struct_AW27* _udpRttBuckets;
