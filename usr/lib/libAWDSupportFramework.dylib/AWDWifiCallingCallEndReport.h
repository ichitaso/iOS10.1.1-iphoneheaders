...
@interface AWDWifiCallingCallEndReport : PBCodable <NSCopying> {
	...
	SCD_Struct_AW27* _frameErasureRateHistograms;
	SCD_Struct_AW27* _jitterBufferResidencyTimeHistograms;
	SCD_Struct_AW27* _jitterBufferUnderflowRateHistograms;
	SCD_Struct_AW27* _rtpPacketLossRateHistograms;
