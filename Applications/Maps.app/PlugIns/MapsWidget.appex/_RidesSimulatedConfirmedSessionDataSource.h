...
@class RidesharingErrorAlertProvider, INIntent, INIntentResponse, NSString, UIImage, CLLocation, NSNumber, NSDate, CLPlacemark, RidesharingSpecialPricingBadge, NSArray, RidesharingAnalyticsBookedSession, NSMapTable;
...
@property (nonatomic,readonly) long long finishingState; 
...
@property (nonatomic,readonly) BOOL hasValidRideStatus;                                                    //@synthesize hasValidRideStatus=_hasValidRideStatus - In the implementation block
