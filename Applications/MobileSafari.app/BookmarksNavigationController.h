...
@property (assign,nonatomic) BOOL hasTranslucentAppearance;                                                                       //@synthesize hasTranslucentAppearance=_hasTranslucentAppearance - In the implementation block
...
-(id)_initWithBookmarksDelegate:(id)arg1 linkPreviewProvider:(id)arg2 topBookmark:(id)arg3 skipOffset:(unsigned)arg4 showOnlyFavorites:(BOOL)arg5 ;
...
-(BOOL)_shouldShowCollectionSegmentedControl;
-(void)_showPalette;
