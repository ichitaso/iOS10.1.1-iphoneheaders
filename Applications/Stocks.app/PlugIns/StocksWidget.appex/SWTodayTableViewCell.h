...
@interface SWTodayTableViewCell : UITableViewCell {
	...
	unsigned long long _changeIndicator;
...
@property (assign,nonatomic) unsigned long long changeIndicator;                             //@synthesize changeIndicator=_changeIndicator - In the implementation block
...
-(void)setChangeIndicator:(unsigned long long)arg1 ;
...
-(long long)inverseNaturalAlignment;
-(unsigned long long)changeIndicator;
