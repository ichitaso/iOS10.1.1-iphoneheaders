...
@class UIView, SBNotificationSeparatorView, SBNotificationCenterLayoutViewController, SBNotificationCenterWithSearchViewController, UIStatusBar, SBNotificationCenterScrollToTopView, SBUIChevronView, UIGestureRecognizer, _UIBackdropView, NSSet, NSString;
