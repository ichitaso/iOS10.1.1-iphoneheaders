...
@class SBApplication, SBLockHardwareButtonActions, NSSet, SBButtonDownGestureRecognizer, SBTapGestureRecognizer, SBLongPressGestureRecognizer, UIGestureRecognizer, SBHomeHardwareButton, NSString;
