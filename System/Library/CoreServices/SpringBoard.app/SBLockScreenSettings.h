...
@property (assign) BOOL showDisconnectAccessory;                                                                         //@synthesize showDisconnectAccessory=_showDisconnectAccessory - In the implementation block
...
-(BOOL)showDisconnectAccessory;
-(void)setShowDisconnectAccessory:(BOOL)arg1 ;
