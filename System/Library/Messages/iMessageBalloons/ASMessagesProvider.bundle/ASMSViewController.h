...
@class UIBarButtonItem, UIViewController, IMBalloonPlugin, IMBalloonPluginDataSource, NSString, CKBrowserDragManager, NSNumber, NSURL, NSObject, ASMSApplicationController, ASMSSegmentedTabBarController;
...
@property (nonatomic,retain) NSURL * storeLaunchURL;                                                                      //@synthesize storeLaunchURL=_storeLaunchURL - In the implementation block
