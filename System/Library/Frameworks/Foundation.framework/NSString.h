...
@interface NSString : NSObject <HFStringGenerator, FCKeyValueStoreCoding, ASParsingLeafNode, CKDParsedObject, PQLValuable, SBFFileCacheFileIdentifier, CNUIURLDestinationID, CSCoderEncoder, CKShortDescription, CKRecordValue, CNKeyDescriptor_Private, NSCopying, NSMutableCopying, NSSecureCoding>
