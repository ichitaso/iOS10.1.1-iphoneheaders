...
@property (nonatomic,readonly) SCD_Struct_AV68 pixelAspectRatio; 
@property (nonatomic,readonly) SCD_Struct_AV69 edgeWidths; 
...
-(CGSize)size;
-(void)dealloc;
-(SCD_Struct_AV68)pixelAspectRatio;
