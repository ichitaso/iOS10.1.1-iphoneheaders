...
@interface AVCaptureFigVideoDevice : AVCaptureDevice <MCProfileConnectionObserver> {
	...
	long long _wbMode;
	SCD_Struct_AV43 _deviceWhiteBalanceGainsKVO;
	SCD_Struct_AV43 _grayWorldDeviceWhiteBalanceGainsKVO;
	BOOL _adjustingWB;
	unsigned long long _wbCalibrationCount;
	SCD_Struct_AV41* _wbCalibrationTemperatures;
...
-(SCD_Struct_AV43)deviceWhiteBalanceGains;
-(SCD_Struct_AV43)grayWorldDeviceWhiteBalanceGains;
-(float)maxWhiteBalanceGain;
-(BOOL)isLockingWhiteBalanceWithCustomDeviceGainsSupported;
-(void)setWhiteBalanceModeLockedWithDeviceWhiteBalanceGains:(SCD_Struct_AV43)arg1 completionHandler:(/*^block*/id)arg2 ;
-(SCD_Struct_AV41)chromaticityValuesForDeviceWhiteBalanceGains:(SCD_Struct_AV43)arg1 ;
-(SCD_Struct_AV43)deviceWhiteBalanceGainsForChromaticityValues:(SCD_Struct_AV41)arg1 ;
-(SCD_Struct_AV41)temperatureAndTintValuesForDeviceWhiteBalanceGains:(SCD_Struct_AV43)arg1 ;
-(SCD_Struct_AV43)deviceWhiteBalanceGainsForTemperatureAndTintValues:(SCD_Struct_AV41)arg1 ;
...
-(int)_setWhiteBalanceWithMode:(long long)arg1 gains:(SCD_Struct_AV43)arg2 requestID:(int)arg3 ;
-(BOOL)_ensureWhiteBalanceCalibrationUnpacked;
-(double)_whiteBalanceMixingFactorForTemperature:(double)arg1 ;
-(double)_predictedTempForGains:(SCD_Struct_AV43)arg1 ;
-(SCD_Struct_AV41)_chromaticityValuesForDeviceWhiteBalanceGains:(SCD_Struct_AV43)arg1 atMix:(double)arg2 ;
-(SCD_Struct_AV43)_deviceWhiteBalanceGainsForChromaticityValues:(SCD_Struct_AV41)arg1 temperature:(double)arg2 ;
