...
@class CNUIContactsEnvironmentServicesProvider, CNUIAccountsFacade, CNUIFMFFacade, _DECConsumer, PRPersonaStore, CNContactStore, CNUIMeContactMonitor, CNContactsEnvironment, CNUIIDSAvailabilityProvider;
