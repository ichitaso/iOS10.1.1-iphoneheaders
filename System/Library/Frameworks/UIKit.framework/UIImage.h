...
@class UITraitCollection, UIImageAsset, NSString, MPArtworkCatalog, NSURL, CIImage, NSArray, UIGraphicsImageRendererFormat;
...
-(SCD_Struct_UI17)bl_pixelAtX:(int)arg1 y:(int)arg2 sampleSize:(float)arg3 ;
-(float)bl_lumaAtX:(int)arg1 y:(int)arg2 sampleSize:(float)arg3 ;
-(SCD_Struct_UI17)bl_pixelAtX:(int)arg1 y:(int)arg2 ;
...
-(CGSize)size;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI19)arg1 inRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
...
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI19)arg1 inRect:(CGRect)arg2 fraction:(double)arg3 ;
...
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI19)arg1 inRect:(CGRect)arg2 ;
