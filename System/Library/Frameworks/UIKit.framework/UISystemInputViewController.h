...
@class NSMutableDictionary, UIResponder, UITraitCollection, UIKeyboard, NSArray, UICompatibilityInputViewController, UIKBSystemLayoutViewController, UIButton, UIViewController, UIRecentsInputViewController, NSLayoutConstraint, UITextInputTraits, UILexicon, UILabel, UIView, NSString;
...
@property (nonatomic,retain) UITraitCollection * containingResponderTraitCollection;                                 //@synthesize containingResponderTraitCollection=_containingResponderTraitCollection - In the implementation block
...
-(void)setContainingResponderTraitCollection:(UITraitCollection *)arg1 ;
...
-(UITraitCollection *)containingResponderTraitCollection;
