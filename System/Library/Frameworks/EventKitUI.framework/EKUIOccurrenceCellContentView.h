...
@class EKUIOccurrenceCellLabel, EKUICellColorBarView, UIImageView, NSArray, UIVisualEffectView, NSLayoutConstraint, UIColor, NSDate, EKCalendarDate, NSString, NSDictionary, NSTimer, UIView, UIVisualEffect;
