...
+(SCD_Struct_CM27)gyroCalibrationDatabaseGetBiasFitAndEstimate:(SCD_Struct_CM3*)arg1 atTemperature:(float)arg2 ;
+(BOOL)hasRunMiniCal;
...
-(void)onGeomagneticModel:(const SCD_Struct_CM21*)arg1 ;
...
-(void)startDeviceMotionLiteUpdatesForDeviceID:(id)arg1 usingConfiguration:(SCD_Struct_CM28)arg2 toQueue:(id)arg3 withFusedHandler:(/*^block*/id)arg4 debugHandler:(/*^block*/id)arg5 ;
