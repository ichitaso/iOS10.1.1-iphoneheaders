...
@interface NSDictionary : NSObject <CKDParsedObject, PQLBindable, CSCoderEncoder, PHFetchDictionaryAccessing, NSFetchRequestResult, NSCopying, NSMutableCopying, NSSecureCoding, NSFastEnumeration>
