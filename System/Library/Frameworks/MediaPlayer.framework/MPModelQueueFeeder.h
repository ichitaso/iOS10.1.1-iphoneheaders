...
@class NSObject, NSHashTable, NSDictionary, NSOperationQueue, MPPlaceholderAVItem, MPModelRequest, NSString, MPModelResponse, MPShuffleController, MPIdentifierSet;
