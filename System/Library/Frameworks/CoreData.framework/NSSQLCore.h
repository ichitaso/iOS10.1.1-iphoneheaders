...
@class NSURL, NSOperationQueue, NSSQLModel, NSSQLiteAdapter, NSSQLiteConnection, NSSQLCoreDispatchManager, NSGenerationalRowCache, NSMutableDictionary, NSString, NSMutableArray;
...
-(id)_retainedRegisterPrefetchRequest:(id)arg1 forKey:(id)arg2 entityID:(unsigned)arg3 ;
-(BOOL)isUbiquitized;
