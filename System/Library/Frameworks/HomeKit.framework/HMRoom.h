...
@interface HMRoom : NSObject <HFReorderableHomeKitObject, HFWallaperHost, HFPrettyDescription, NSSecureCoding, HMFMessageReceiver, HMObjectMerge, HMMutableApplicationData> {
