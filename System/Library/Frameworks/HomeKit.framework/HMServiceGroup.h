...
@interface HMServiceGroup : NSObject <HFReorderableHomeKitObject, HFFavoritable, HFNotificationPreferences, HFHomeStatusVisible, HFPrettyDescription, HMFMessageReceiver, NSSecureCoding, HMObjectMerge, HMMutableApplicationData> {
