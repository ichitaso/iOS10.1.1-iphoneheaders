...
@class NSUUID, NSString, HMHome, HMRoom, NSArray, HMAccessoryCategory, HMApplicationData, NSNumber, HMFMessageDispatcher, HMThreadSafeMutableArrayCollection, NSObject, HMDelegateCaller, HFServiceNameComponents, NSDate;

@interface HMAccessory : NSObject <HFReorderableHomeKitObject, HFFavoritable, HFPrettyDescription, NSSecureCoding, HMFMessageReceiver, HMObjectMerge, HMMutableApplicationData> {
