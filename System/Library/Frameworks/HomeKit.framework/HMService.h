...
@interface HMService : NSObject <HFReorderableHomeKitObject, HFNotificationPreferences, HFHomeStatusVisible, HFFavoritable, HFPrettyDescription, NSSecureCoding, HMObjectMerge, HMMutableApplicationData> {
