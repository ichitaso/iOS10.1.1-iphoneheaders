...
@interface HMActionSet : NSObject <HFReorderableHomeKitObject, HFFavoritable, HFPrettyDescription, HMFMessageReceiver, NSSecureCoding, HMObjectMerge, HMMutableApplicationData> {
