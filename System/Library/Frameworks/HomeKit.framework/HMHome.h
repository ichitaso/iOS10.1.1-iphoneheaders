...
@interface HMHome : NSObject <HFReorderableHomeKitObject, HFWallaperHost, HFCharacteristicValueReader, HFCharacteristicValueWriter, _HMLocationHandlerDelegate, NSSecureCoding, HMFMessageReceiver, HMObjectMerge, HMMutableApplicationData> {
