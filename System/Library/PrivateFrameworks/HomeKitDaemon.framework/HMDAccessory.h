...
@class NSMutableArray, NSString, HMDCharacteristic, HMDApplicationData, NSSet, HMDRoom, NSNumber, HMDHome, NSUUID, NSObject, HMFTimer, HMFMessageDispatcher, HMAccessoryCategory, NSMutableSet, NSData, HMDApplicationRegistry, HMDBridgeInformation, NSArray;
...
-(void)handleMultipleCharacteristicsUpdated:(id)arg1 filterUnmodifiedCharacteristics:(BOOL)arg2 queue:(id)arg3 remoteDevice:(id)arg4 notificationUpdateIdentifier:(id)arg5 completionHandler:(/*^block*/id)arg6 ;
...
-(void)_handleMultipleCharacteristicsUpdated:(id)arg1 filterUnmodifiedCharacteristics:(BOOL)arg2 queue:(id)arg3 remoteDevice:(id)arg4 notificationUpdateIdentifier:(id)arg5 completionHandler:(/*^block*/id)arg6 ;
