...
@property (nonatomic,readonly) SCD_Struct_MT52 viewport;                                               //@synthesize viewport=_viewport - In the implementation block
...
-(void)_setDefaults;
-(SCD_Struct_MT52)viewport;
-(void)setViewport:(SCD_Struct_MT52)arg1 ;
@end
