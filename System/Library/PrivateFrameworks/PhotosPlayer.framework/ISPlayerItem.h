...
+(id)playerItemWithAsset:(id)arg1 targetSize:(CGSize)arg2 trimmedTimeRange:(SCD_Struct_IS7)arg3 ;
-(id)init;
-(void)dealloc;
-(CGSize)targetSize;
-(ISAsset *)asset;
...
-(id)initWithAsset:(id)arg1 targetSize:(CGSize)arg2 trimmedTimeRange:(SCD_Struct_IS7)arg3 ;
