...
@class NSObject, PKPaymentPass, PKLinkedApplication, PKPaymentApplication, PKPaymentWebService, PKPaymentVerificationController, PKPaymentPassDetailActivationFooterView, NSNumberFormatter, PKSettingTableCell, NSNumber, NSArray, NSMutableDictionary, PKFelicaPassProperties, UIView, PKPassHeaderView, UIVisualEffectView, UISegmentedControl, UIColor, NSString;
