...
@class NSOperationQueue, NSString, CKDResponseBodyParser, NSMutableDictionary, NSMutableArray, NSData, CKDProtobufStreamWriter, NSMutableData, NSObject, NSDictionary, CKTimeLogger, CKDClientContext, CKDProtocolTranslator, NSArray, NSError, NSURLSessionConfiguration, NSURLSessionDataTask, NSURLRequest, NSHTTPURLResponse, NSFileHandle, CKBlockingAsyncQueue, NSDate, CKDOperationMetrics, NSInputStream, NSURL;
