...
@class NSString, IKDOMDocument, NSDictionary, ISURLOperation, NSMutableArray, NSMutableURLRequest, NSURLConnection, NSHTTPURLResponse, NSData, NSError, JSManagedValue;
