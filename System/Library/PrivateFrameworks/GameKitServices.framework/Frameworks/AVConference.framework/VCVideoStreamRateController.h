...
-(unsigned)minBitrate;
-(void)doRateControlWithTime:(double)arg1 roundTripTime:(double)arg2 packetLossRate:(double)arg3 operatingBitrate:(unsigned)arg4 actualBitrate:(unsigned)arg5 ;
-(unsigned)maxBitrate;
