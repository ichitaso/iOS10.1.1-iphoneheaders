...
-(tagCommNATInfo*)callCommNATTestFromIPPort:(tagIPPORT*)arg1 ipv6Prefix:(SCD_Struct_GK3*)arg2 ;
-(void)cacheNATFlags:(id)arg1 forNetwork:(id)arg2 ;
-(int)callHTTPTestFromIPPort:(tagIPPORT*)arg1 ipv6Prefix:(SCD_Struct_GK3*)arg2 ToServer:(id)arg3 isSSL:(BOOL)arg4 ;
-(void)NATCheckWithIPPort:(tagIPPORT*)arg1 ipv6Prefix:(SCD_Struct_GK3*)arg2 useCache:(BOOL)arg3 ;
-(void)HTTPCheckWithIPPort:(tagIPPORT*)arg1 ipv6Prefix:(SCD_Struct_GK3*)arg2 useCache:(BOOL)arg3 ;
-(void)HTTPSCheckWithIPPort:(tagIPPORT*)arg1 ipv6Prefix:(SCD_Struct_GK3*)arg2 useCache:(BOOL)arg3 ;
