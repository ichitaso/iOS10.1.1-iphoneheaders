...
@property (readonly) NSMutableDictionary * stateCacheForCallID;                                                        //@synthesize stateCacheForCallID=_stateCacheForCallID - In the implementation block
...
-(NSMutableDictionary *)stateCacheForCallID;
