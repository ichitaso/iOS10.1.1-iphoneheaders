...
@class TSUTemporaryDirectory, NSString, NSObject, NSMutableSet, NSURL, NSOperationQueue, NSMutableArray, NSError, TSPObjectContext, TSUProgressContext, TSAUbiquitousRefreshQueue, NSDictionary, NSUUID;
