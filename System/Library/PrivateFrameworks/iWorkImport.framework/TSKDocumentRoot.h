...
@property (nonatomic,readonly) BOOL isCommandControllerConfiguredForCollaboration;                                       //@synthesize isCommandControllerConfiguredForCollaboration=_isCommandControllerConfiguredForCollaboration - In the implementation block
@property (nonatomic,readonly) TSKCollaborationCommandHistory * collaborationCommandHistory;                             //@synthesize collaborationCommandHistory=_collaborationCommandHistory - In the implementation block
@property (nonatomic,readonly) TSKCommandHistory * commandHistory;                                                       //@synthesize commandHistory=_commandHistory - In the implementation block
@property (nonatomic,readonly) BOOL hasCommands;                                                                         //@synthesize hasCommands=_hasCommands - In the implementation block
@property (nonatomic,readonly) unsigned long long undoCount;                                                             //@synthesize undoCount=_undoCount - In the implementation block
@property (nonatomic,readonly) unsigned long long redoCount;                                                             //@synthesize redoCount=_redoCount - In the implementation block
@property (nonatomic,readonly) NSString * undoActionString;                                                              //@synthesize undoActionString=_undoActionString - In the implementation block
@property (nonatomic,readonly) NSString * redoActionString;                                                              //@synthesize redoActionString=_redoActionString - In the implementation block
...
-(TSKCollaborationCommandHistory *)collaborationCommandHistory;
