...
@class NSDictionary, KNSlideNode, KNTitlePlaceholderInfo, KNBodyPlaceholderInfo, KNObjectPlaceholderInfo, KNSlideNumberPlaceholderInfo, KNSlideStyle, KNSlideBackgroundInfo, NSOrderedSet, NSMutableDictionary, NSSet, NSArray, TSUPointerKeyDictionary, TSUMutablePointerSet, KNTransition, TSDFill, NSString, TSDInfoGeometry;
