...
@interface BWFigVideoCaptureDevice : BWCaptureDevice <BWZoomCompletionDelegate> {
	...
	SCD_Struct_BW74 _currentFrameStatistics;
...
-(id)stillImageCaptureSettingsForCaptureType:(int)arg1 frameStatistics:(SCD_Struct_BW74*)arg2 deliverOriginalImage:(BOOL)arg3 deliverSushiRaw:(BOOL)arg4 includePreBracketedEV0ForProcessing:(BOOL)arg5 clientBracketSettings:(id)arg6 stereoFusionMode:(int)arg7 ;
...
-(int)resolveStillImageCaptureTypeFromStatistics:(SCD_Struct_BW74*)arg1 flashMode:(int)arg2 hdrMode:(int)arg3 sisMode:(int)arg4 autoShallowDepthOfFieldEffectEnabled:(BOOL)arg5 clientBracketMode:(int)arg6 ;
...
-(void)getCurrentVideoFrameStatistics:(SCD_Struct_BW74*)arg1 ;
...
-(void)_serviceSynchronizedStreamsWithSampleBuffer:(opaqueCMSampleBufferRef)arg1 fromCaptureStream:(id)arg2 frameStatistics:(SCD_Struct_BW74*)arg3 ;
-(void)_serviceSDOFEffectStatusWithSampleBuffer:(opaqueCMSampleBufferRef)arg1 frameStatistics:(SCD_Struct_BW74*)arg2 ;
-(void)_serviceRetryStillImageCaptureUsingFrameStatistics:(SCD_Struct_BW74*)arg1 ;
...
-(id)_bravoStillImageCaptureSettingsForCaptureType:(int)arg1 frameStatistics:(SCD_Struct_BW74*)arg2 deliverOriginalImage:(BOOL)arg3 includePreBracketedEV0ForProcessing:(BOOL)arg4 clientBracketSettings:(id)arg5 stereoFusionMode:(int)arg6 ;
-(id)_stillImageCaptureSettingsForCaptureType:(int)arg1 frameStatistics:(SCD_Struct_BW74*)arg2 deliverOriginalImage:(BOOL)arg3 deliverSushiRaw:(BOOL)arg4 includePreBracketedEV0ForProcessing:(BOOL)arg5 clientBracketSettings:(id)arg6 ;
-(void)_captureStillImageNowWithSettings:(id)arg1 ;
-(void)_stillImageCaptureStateMachineDidTransitionToInProgress;
-(int)_stillImageSceneTypeForFrameStatistics:(SCD_Struct_BW74*)arg1 flashSceneDetectionEnabled:(BOOL)arg2 hdrSceneDetectionEnabled:(BOOL)arg3 sisSceneDetectionEnabled:(BOOL)arg4 ;
-(int)_bravoCameraForOISOrSISCaptureType:(int)arg1 stereoFusionMode:(int)arg2 frameStatistics:(SCD_Struct_BW74*)arg3 zoomFactor:(float)arg4 stereoFusionLowerBoundZoomFactor:(float)arg5 stereoFusionUpperBoundZoomFactor:(float)arg6 ;
...
-(unsigned)_stillImageCaptureInProgressSubstateForFrameStatistics:(SCD_Struct_BW74*)arg1 captureType:(int)arg2 stereoFusionCapture:(BOOL)arg3 ;
...
-(void)_updateSwitchOverStateForCurrentMasterStream:(id)arg1 frameStatistics:(SCD_Struct_BW74*)arg2 ;
-(void)_updateBravoCameraSelectionBehaviorForMasterStream:(id)arg1 ;
-(BOOL)_switchToOtherStreamForCurrentMasterStream:(id)arg1 requestedZoomFactor:(float)arg2 frameStatistics:(SCD_Struct_BW74*)arg3 selectionBehavior:(int)arg4 ;
...
-(void)_serviceAutoTorchNotification:(SCD_Struct_BW74*)arg1 ;
