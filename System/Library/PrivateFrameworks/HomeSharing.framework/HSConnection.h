...
@property (assign,nonatomic) unsigned interfaceID;                          //@synthesize interfaceID=_interfaceID - In the implementation block
@property (assign,nonatomic) unsigned controlKey;                           //@synthesize controlKey=_controlKey - In the implementation block
@property (assign,nonatomic) unsigned controlPort;                          //@synthesize controlPort=_controlPort - In the implementation block
