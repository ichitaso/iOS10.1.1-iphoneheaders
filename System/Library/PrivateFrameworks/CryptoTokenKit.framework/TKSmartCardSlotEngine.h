...
@class TKSmartCardATR, NSXPCConnection, NSXPCListener, NSHashTable, NSMutableArray, NSMapTable, TKPowerMonitor, NSArray, NSString, NSObject, TKSmartCardSessionEngine;
