...
@class ExportController, PHActivityProgressViewController, NSString, Project, NSObject;
...
@property (nonatomic,retain) ExportController * exportController;                                           //@synthesize exportController=_exportController - In the implementation block
...
-(void)setExportController:(ExportController *)arg1 ;
