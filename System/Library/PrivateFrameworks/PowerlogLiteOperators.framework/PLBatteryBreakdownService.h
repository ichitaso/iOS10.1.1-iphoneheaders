...
@property (nonatomic,retain) NSSet * internalAppNames;                                         //@synthesize internalAppNames=_internalAppNames - In the implementation block
...
-(NSSet *)rootNodeNames;
-(NSSet *)internalAppNames;
-(NSSet *)nonAppNames;
-(NSSet *)webAppNames;
-(BOOL)showGizmoQualifier;
-(void)setInternalAppNames:(NSSet *)arg1 ;
