...
@interface MNTrafficIncidentAlert : NSObject {
	...
	SCD_Struct_MN20 _startValidCoordinateRange;
	SCD_Struct_MN20 _endValidCoordinateRange;
	SCD_Struct_MN20 _incidentCoordinate;
	NSDate* _alertDate;
...
@property (nonatomic,readonly) SCD_Struct_MN20 startValidCoordinateRange;              //@synthesize startValidCoordinateRange=_startValidCoordinateRange - In the implementation block
@property (nonatomic,readonly) SCD_Struct_MN20 endValidCoordinateRange;                //@synthesize endValidCoordinateRange=_endValidCoordinateRange - In the implementation block
@property (nonatomic,readonly) SCD_Struct_MN20 incidentCoordinate;                     //@synthesize incidentCoordinate=_incidentCoordinate - In the implementation block
...
-(NSData *)alertID;
-(SCD_Struct_MN20)startValidCoordinateRange;
-(SCD_Struct_MN20)endValidCoordinateRange;
-(SCD_Struct_MN20)incidentCoordinate;
...
-(BOOL)isCoordinateInValidRange:(SCD_Struct_MN20)arg1 ;
-(BOOL)isSimilarTo:(id)arg1 ;
-(void)updateAlertIDWithAlert:(id)arg1 ;
-(void)_findRouteDivergence;
-(SCD_Struct_MN20)_routeCoordinateAtDuration:(double)arg1 beforeRouteCoordinate:(SCD_Struct_MN20)arg2 ;
