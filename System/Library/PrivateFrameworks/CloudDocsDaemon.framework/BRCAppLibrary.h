...
@class NSString, NSNumber, NSMutableIndexSet, NSMutableSet, BRCAccountSession, BRCClientZone, NSObject, brc_task_tracker, BRCPQLConnection, BRCALRowID, BRCZoneRowID, BRCRelativePath, BRCFSEventsMonitor, NSURL, BRCPrivateAppLibrary, BRCSharedAppLibrary, BRCSyncContext, NSMutableDictionary;
