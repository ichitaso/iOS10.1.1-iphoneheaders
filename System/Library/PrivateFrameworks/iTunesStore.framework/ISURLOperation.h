...
@class NSData, NSString, NSURLCache, NSURLRequest, SSAuthenticationContext, NSMutableData, ISDataProvider, NSCountedSet, SSMutableURLRequestProperties, NSURLResponse, SSURLSessionManager, NSURLSessionTask, ISURLRequestPerformance, NSArray, SSURLRequestProperties;
