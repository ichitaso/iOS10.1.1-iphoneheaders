...
@property (nonatomic,copy) NSNumber * transitBalance;                                                  //@synthesize transitBalance=_transitBalance - In the implementation block
...
-(void)setTransitBalance:(NSNumber *)arg1 ;
