...
@class UIImage, UITapGestureRecognizer, UILongPressGestureRecognizer, NSMutableArray, CABackdropLayer, CKInvisibleInkEffectController, CKManualUpdater, CKBalloonImageView, UIColor, NSString;
