...
@interface CKBrowserSelectionController : CKBrowserViewController <UICollectionViewDelegate, UICollectionViewDataSource, CKBrowserSelectionFlowLayoutDelegate, CKBrowserCellDelegate, UIGestureRecognizerDelegate> {
