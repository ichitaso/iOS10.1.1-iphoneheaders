...
@class UIViewController, CKMessageEntryView, UIView, CKDismissView, CKConversation, UIWindow, CKBrowserSelectionController, CKFullScreenAppNavbarManager, IMBalloonPlugin, CADisplayLink, UISimpleInteractionProgress, NSString, IMBalloonPluginDataSource, CKBrowserDragManager, NSNumber, NSURL;
