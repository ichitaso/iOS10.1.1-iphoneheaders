...
@class NSIndexPath, NSArray, CKConversation, UIView, NSObject, NSIndexSet, CKImpactEffectManager, CKFullScreenEffectManager, UITapGestureRecognizer, CKTranscriptCollectionView, CKAudioController, CKPluginPlaybackManager, CKImpactEffectHapticsGenerator, NSString, NSMutableSet, IMChat;
