...
@class HFItem, HMHome, NAFuture, NSArray, NSMutableDictionary, NSMutableSet, NSString, NSSet;
...
-(id)_reloadItemProvidersWithInvalidationReasons:(id)arg1 updateItems:(id)arg2 senderSelector:(SEL)arg3 updatedHome:(id)arg4 readValidator:(/*^block*/id)arg5 ;
-(id)_itemsToUpdateForModifiedMetadataForHomes:(id)arg1 ;
-(/*^block*/id)_readValidatorAllowingNoReads;
