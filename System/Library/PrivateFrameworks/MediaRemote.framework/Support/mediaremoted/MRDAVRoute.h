...
@property (nonatomic,readonly) BOOL canBeDefaultSystemRoute;                       //@synthesize canBeDefaultSystemRoute=_canBeDefaultSystemRoute - In the implementation block
