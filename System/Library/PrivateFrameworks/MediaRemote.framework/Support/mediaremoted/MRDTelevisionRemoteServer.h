...
@class MRDTelevisionServerNetworkService, NSRunLoop, NSMutableSet, NSObject, MRDSystemHIDEventManager, MRDTelevisionStateObserver, MRDTelevisionGameControllerServer, MRDPinPairingDialog, MRDeviceInfoObserver, MRDAVRoutingDataSource, NSString;

@interface MRDTelevisionRemoteServer : NSObject <NSStreamDelegate, MRCryptoPairingSessionDelegate, MRDTelevisionServerNetworkServiceDelegate, MRDTelevisionStateObserverDelegate, MRDTelevisionTextEditingServiceDelegate, MRTelevisionClientConnectionDelegate, MRDTelevisionGameControllerServerDelegate, MRDeviceInfoObserving, MRDPinPairingDialogDelagate, MRDXPCMessageHandling> {
