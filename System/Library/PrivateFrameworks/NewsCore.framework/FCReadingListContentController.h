...
@class NSArray, NSDictionary, FCKeyedOperationQueue, NSObject, NSMutableDictionary, FCCloudContext, NSMutableSet, NSOperationQueue, NSString;
...
@property (nonatomic,copy) NSArray * allSortedArticleIDsInReadingList;                                 //@synthesize allSortedArticleIDsInReadingList=_allSortedArticleIDsInReadingList - In the implementation block
...
-(NSArray *)allSortedArticleIDsInReadingList;
-(void)setAllSortedArticleIDsInReadingList:(NSArray *)arg1 ;
