...
@class NSDictionary, PBCodable, NSString, SYSession, NSObject, _SYMultiSuspendableQueue, SYPersistentStore, SYSyncEngine, SYVectorClock, NSMutableSet, _SYQueuedStartSession, SYDevice, NSMutableArray;
