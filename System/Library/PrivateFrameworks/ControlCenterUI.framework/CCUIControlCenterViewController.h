...
@class CCUIControlCenterPageContainerViewController, NSMutableArray, NSArray, NSMapTable, CCUISystemControlsPageViewController, CCUIControlCenterContainerView, CCUIImmediateTouchScrollView, CCUIControlCenterPageControl, UIPanGestureRecognizer, UITapGestureRecognizer, CCUIControlCenterSettings, NSString;
