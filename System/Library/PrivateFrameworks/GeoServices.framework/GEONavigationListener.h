...
@interface GEONavigationListener : NSObject <GEONavigationServerObserverXPCInterface> {
	...
	/*^block*/id _selectedRideOptionUpdatedHandler;
...
@property (nonatomic,copy) id selectedRideOptionUpdatedHandler;                  //@synthesize selectedRideOptionUpdatedHandler=_selectedRideOptionUpdatedHandler - In the implementation block
...
-(id)selectedRideOptionUpdatedHandler;
-(void)setSelectedRideOptionUpdatedHandler:(id)arg1 ;
@end
