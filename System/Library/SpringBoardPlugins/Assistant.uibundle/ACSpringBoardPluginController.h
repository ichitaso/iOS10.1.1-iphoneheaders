...
@class AFConnection, AFRemoteRequestWatcher, AFSiriTether, AFUISiriViewController, NSObject, SUICApplicationStateHelper, AFDialogPhase, VTPhraseSpotterControlRemote, NSTimer, CMPocketStateManager, NSMutableArray, AFMyriadCoordinator, NSArray, AFUISiriLanguage, ACBulletinManager, ACHeater, NSString, AFQueue, BluetoothDevice, NSDate;

@interface ACSpringBoardPluginController : SBUIPluginController <ACBulletinManagerDelegate, ACHeaterDelegate, AFUISiriLanguageDelegate, AFUISiriViewControllerDataSource, AFUISiriViewControllerDelegate, CMPocketStateDelegate, AFMyriadDelegate, VTPhraseSpotterControlRemoteDelegate> {
