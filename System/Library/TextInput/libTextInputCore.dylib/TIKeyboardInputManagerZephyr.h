...
-(CFArrayRef)copySkinToneSensitiveEmojis:(CFArrayRef)arg1 ;
...
-(EmojiTokenWrapperRef)copyRecentEmojiTokenForEmoji:(EmojiTokenWrapperRef)arg1 skinTones:(id)arg2 ;
-(id)emojiReplacementCandidates:(id)arg1 ;
-(void)updateEmojiAdornmentGenerators;
-(id)randomShuffle:(id)arg1 ;
-(CFArrayRef)copyEmojiTokenRefsFromEmojiStrings:(CFArrayRef)arg1 localeData:(EmojiLocaleDataWrapperRef)arg2 ;
-(id)skinToneModifiedAdornmentEmojis:(CFArrayRef)arg1 forLocale:(EmojiLocaleDataWrapperRef)arg2 ;
