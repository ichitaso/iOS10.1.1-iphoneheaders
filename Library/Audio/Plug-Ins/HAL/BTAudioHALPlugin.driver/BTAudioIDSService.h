...
-(void)handleRequestOwnership:(basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >)arg1 ;
...
-(BOOL)compatibleAndNearby;
-(BOOL)compatibleAndConnected;
-(void)handleDidTakeOwnership:(basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >)arg1 ;
...
-(BOOL)sendArbitrationMsg:(id)arg1 forAddress:(basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >)arg2 ;
